...
cp /root/BashScripting/ExpenseProjectShell/backend.service /etc/systemd/system/backend.service &>>$LOG_FILE
...
mysql -h mysql.dev.arun-753.com -uroot -pExpenseApp@1 < /app/schema/backend.sql &>>$LOG_FILE
